        ...
        <div
            ...
            <div className={'flex flex-col gap-3'} ref={(el) => {
                ...
                <div className={'flex flex-col gap-3'}>
                    <div className={'w-[21.5rem] h-[21rem] bg-[#E7E7E7] rounded-[3.25rem] shrink-0 flex items-center justify-center'}>
                        <div
            ...
            <div className={'flex flex-col gap-3 first:-translate-y-[74.5%] -translate-y-[174.5%]'} ref={(el) => {
            ...
            <div className={'flex flex-col gap-3'} ref={(el) => {
                ...
                <div className={'flex flex-col gap-3'}>
                    <div className="w-[21.5rem] h-[21rem] bg-[#E7E7E7] rounded-[3.25rem] shrink-0 flex items-center justify-center">
                        <div
                            className="w-[4.75rem] h-[2.75rem] bg-[#C1C1C1] object-fill"
                            style={{
                                WebkitMask: "url('/assets/gray-images/vtb.png') no-repeat center",
                                mask: "url('/assets/gray-images/vtb.png') no-repeat center",
                                maskSize: 'contain',
                            }}
                        />
                    </div>
