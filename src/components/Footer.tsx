...
const Footer = () => {
    return (
        <div className={'flex w-full justify-center bg-[#F2F2F2] pt-[14.3rem] max-md:px-3 max-md:pt-[8rem] max-lg:px-5.5'}>
            <div className={'w-full flex max-w-[86.25rem] flex-col bg-[#F2F2F2]'}>
                <div className={'w-full flex justify-between items-end flex-wrap'}>
                    <div className={'flex flex-col gap-4'}>
                        ...
                        <p className={'text-lg font-medium text-[#434343] leading-[1.3rem]'}>Хотите, чтобы ваш бизнес
                            рос
                    ...
                    <div className={'flex max-w-[26.5rem] w-full justify-between max-md:mt-12'}>
                        ...
                        <div className={'flex flex-col'}>
                            ...
                            <nav className={'gap-1 flex flex-col'}>
                                <Link href={'https://profprivelegies.ru/'}
                                      className={'text-[#747474] text-base underline'}
                                      target={"_blank"}>Союз преимуществ</Link>
                                <Link href={'#'} className={'text-[#747474] text-base underline'}>+7 901
                                    457-31-86</Link>
                                <Link href={'#'}
