...
const HeroSection = () => {
    ...
    return (
        <div className={'bg-[#f2f2f2] w-full flex flex-col items-center max-md:px-1.5 max-lg:pb-[15rem] max-lg:px-2.5'}
             ref={triggerBlockRef}>
            <div
            ...
            <span
                className={'font-medium text-black text-center'}>членов профсоюзов.</span>
                    ...
                    <div className={'flex items-center gap-0.5'}>
                        <span
                            className={'font-medium text-black text-center'}>Увеличьте продажи — без затрат на рекламу</span>
